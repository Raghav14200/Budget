It is a web application that can be used by all for tracking their expenses accordingly. It is built using Html, Bootstrap, PHP and SQL for database management.
